...
# Mouse data
TRAIN_IMAGES = '..\..\source\Mouse_sequence2.txt'
TRAIN_LABELS = '..\..\source\Mouse_label2.txt'
DATA_NUM = 54710

FLAGS = None

# Parameters
LOGS_DIRECTORY = "logs/1vs2"
TOTAL_BATCH = 40000
learn_rate = 0.001
batch_size = 256
seeds_num = 20
...
def main(_):
    ...
    data_frame.to_csv('mouse1vs2.csv', index=True, columns=['AUC', 'ACC', 'SP', 'SN', 'Test ACC'])
