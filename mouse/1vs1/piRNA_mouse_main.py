...
import piRNA_mouse_model as model
import tensorflow as tf
import pandas as pd

# Mouse data
TRAIN_IMAGES = '..\..\source\Mouse_sequence1.txt'
TRAIN_LABELS = '..\..\source\Mouse_label1.txt'
DATA_NUM = 27996

FLAGS = None

# Parameters
LOGS_DIRECTORY = "logs/1vs1"
TOTAL_BATCH = 40000
learn_rate = 0.001
batch_size = 256
seeds_num = 20
...
def main(_):
    ...
    data_frame.to_csv('mouse1vs1.csv', index=True, columns=['AUC', 'ACC', 'SP', 'SN', 'Test ACC'])
