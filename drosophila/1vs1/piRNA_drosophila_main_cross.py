...
# Drosophila data
TRAIN_IMAGES = '..\..\source\Drosophila_sequence1.txt'
TRAIN_LABELS = '..\..\source\Drosophila_label1.txt'
DATA_NUM = 18428
...
def main(_):
    ...
    data_frame.to_csv('drosophila1vs1cross.csv', index=True, columns=['AUC', 'ACC', 'SP', 'SN', 'Test ACC'])
