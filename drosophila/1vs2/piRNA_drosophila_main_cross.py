...
# Drosophila data
TRAIN_IMAGES = '..\..\source\Drosophila_sequence2.txt'
TRAIN_LABELS = '..\..\source\Drosophila_label2.txt'
DATA_NUM = 27642
...
def main(_):
    ...
    data_frame.to_csv('drosophila1vs2cross.csv', index=True, columns=['AUC', 'ACC', 'SP', 'SN', 'Test ACC'])
