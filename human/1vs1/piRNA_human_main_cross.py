...
# Human data
TRAIN_IMAGES = '..\..\source\Human_sequence1.txt'
TRAIN_LABELS = '..\..\source\Human_label1.txt'
DATA_NUM = 14810

FLAGS = None

# Parameters
LOGS_DIRECTORY = "logs/1vs1cross"
TOTAL_BATCH = 40000
learn_rate = 0.001
batch_size = 256
seeds_num = 20
...
def main(_):
    ...
    data_frame.to_csv('human1vs1cross.csv', index=True, columns=['AUC', 'ACC', 'SP', 'SN', 'Test ACC'])
