...
import pandas as pd
import piRNA_cross_species_human as cross

# Human data
TRAIN_IMAGES = '..\..\source\Human_sequence2.txt'
TRAIN_LABELS = '..\..\source\Human_label2.txt'
DATA_NUM = 22215

FLAGS = None

# Parameters
LOGS_DIRECTORY = "logs/1vs2cross"
TOTAL_BATCH = 40000
learn_rate = 0.001
batch_size = 256
seeds_num = 20
...
def main(_):
    ...
    data_frame.to_csv('human1vs2cross.csv', index=True, columns=['AUC', 'ACC', 'SP', 'SN', 'Test ACC'])
